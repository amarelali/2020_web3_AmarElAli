...
<div class="container-fluid" >
    ...
    <?php     
        ...
        while ($row = mysqli_fetch_assoc($result)) { 
          ...
          <form id="search" method='post' action='Items.php?categorieName=<?php echo $value ?>' style="margin:auto">
        ...
        while ($row = mysqli_fetch_assoc($result)) { 
            foreach ($row as $field => $value) { ?>
     <a href="#" onclick="document.getElementById('search').submit();"  class="col-5 col-md-3" 
